...
sbit stop= P1^5;
sbit finish = P1^6;
sbit party1=P1^1;  //Candidate1 (P01)
sbit party2=P1^2;  //Candidate2 (P02)
sbit party3=P1^3;  //Candidate3 (P03)
sbit party4=P1^4;  //Candidate4 (P04)
sbit led1 = P3^3;  // P01 led
sbit led2 = P3^4;  // P02 led
sbit led3 = P3^5;  // P03 led
sbit led4 = P3^6;  // P04 led
